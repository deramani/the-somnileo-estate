...
export default function GalleryPage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#020203] text-[#E5DED3]">
      ...
      {/* Darkness */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#000000] via-[#05050A] to-[#010102]" />

      {/* Cold moon wound */}
      <div className="absolute top-[8%] left-1/2 h-[400px] w-[600px] -translate-x-1/2 rounded-full bg-[#BAC0CC]/4 blur-[180px]" />
...
>
  <div className="absolute top-[22%] left-[18%] h-[140px] w-[140px] rounded-full bg-[#BAC0CC]/[0.035] blur-[80px]" />

  <div className="absolute top-[48%] left-[48%] h-[120px] w-[120px] rounded-full bg-[#BAC0CC]/[0.025] blur-[70px]" />

  <div className="absolute bottom-[20%] right-[16%] h-[150px] w-[150px] rounded-full bg-[#BAC0CC]/[0.03] blur-[80px]" />
</motion.div>    
      ...
      <section className="relative z-10 px-8 py-24">
        ...
        <div className="max-w-4xl mx-auto text-center mb-24">
          ...
          <p className="font-[family-name:var(--font-spectral)] max-w-2xl mx-auto text-[#98A0B0] text-lg md:text-xl leading-relaxed">
            Strange imaginings, shadowed beauty, relics of dream,
            fragments remembered imperfectly.
          </p>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {[
            ...
            >
              ...
              {/* Cold moonlight */}
              <div className="absolute top-0 left-1/2 h-[220px] w-[220px] -translate-x-1/2 rounded-full bg-[#BAC0CC]/5 blur-[90px] opacity-0 transition duration-1000 group-hover:opacity-100" />
